use super::{
    GRID_BG_COLOR, HINT_BG_COLOR, MIN_SIZE_OF_SQUARE_PERCENT, SIDE_MARGIN_RATIO, TOP_HINTS_PERCENT,
    TOP_MARGIN_PERCENT,
};
...
fn update_bg(
    mut grid_bg: Single<&mut Transform, (With<GridBg>, Without<TopHintBg>)>,
    mut top_hint_bg: Single<&mut Transform, (With<TopHintBg>, Without<GridBg>)>,
